...
# Canonical output root (profile absolute eval_runs_dir) — NOT mock_run/eval_runs.
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if out is None:
        ...
        out = Path(__file__).resolve().parents[3] / "eval_runs" / f"_probe_insurance_{stamp}" / "cases" / args.case_id
    r = run_smoke_turn(
